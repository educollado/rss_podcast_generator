...
filehandle.write('\n		<link>{}</link>'.format(channel['web_link']))
filehandle.write('\n	</image>')
filehandle.write('\n	<itunes:category text="{}" />'.format(channel['itunes']['categories'][0]))
filehandle.write('\n	<googleplay:category text="{}"/>'.format(channel['itunes']['categories'][0]))
filehandle.write('\n	<itunes:category text="{}" />'.format(channel['itunes']['categories'][1]))
filehandle.write('\n	<itunes:category text="{}" />'.format(channel['itunes']['categories'][2]))
...
for i in items:
	...
	filehandle.write('\n	<category><![CDATA[{}]]></category>'.format(i['categories'][0]))
	filehandle.write('\n	<category><![CDATA[{}]]></category>'.format(i['categories'][1]))
	filehandle.write('\n	<category><![CDATA[{}]]></category>'.format(i['categories'][2]))
